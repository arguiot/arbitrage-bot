...
export default async function handler(req, res) {
    ...
    const TokenA = new ethers.ContractFactory(_TokenA.abi, _TokenA.bytecode, deployer);
    const TokenB = new ethers.ContractFactory(_TokenB.abi, _TokenB.bytecode, deployer);
