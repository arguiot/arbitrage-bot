...
export async function deployUniswapV2(deployer: Signer): Promise<{
    ...
    const UniswapV2Factory = new ethers.ContractFactory(_UniswapV2Factory.abi, _UniswapV2Factory.bytecode, deployer);
    const UniswapV2Router02 = new ethers.ContractFactory(
        _UniswapV2Router02.abi,
        _UniswapV2Router02.bytecode,
        deployer
    );
    const WETH9 = new ethers.ContractFactory(_WETH9.abi, _WETH9.bytecode, deployer);
